...
echo '#!'$PREFIX/bin/bash >> xfce
echo 'am start --user 0 -n com.termux.x11/com.termux.x11.MainActivity && termux-x11 :1 -xstartup xfce4-session' >> xfce
echo '#!'$PREFIX/bin/bash >> quit
echo 'xfce4-session-logout --logout' >> quit
chmod +x xfce quit
cd ~
